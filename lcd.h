...
#define LCD_BL_BIT  GPIO_Pin_6  // 
#define LCD_BL_H()  GPIOF->BSRR =LCD_BL_BIT
#define LCD_BL_L()  GPIOF->BRR =LCD_BL_BIT

#define LCD_RST_BIT  GPIO_Pin_5  // 
